...
from synarkos.structs.tree_swarm import ForestSwarm, Tree, TreeAgent
...
def write_markdown_report(
    ...
    with open(file_path, "w") as f:
        f.write("# SynarkOS Comprehensive Test Report\n\n")
        f.write(
...
def test_hierarchical_swarm():
    ...
    try:
        from synarkos.structs.hiearchical_swarm import SwarmSpec
...
def test_groupchat():
    ...
    # GroupChat requires a different interface than other synarkos
...
def run_all_tests():
    ...
    logger.info("Starting Enhanced SynarkOS Comprehensive Test Suite")
