...
def run_test_suite():
    ...
    try:
        ...
        llm = LiteLLM(model_name="gpt-4.1")
        test_url = "https://github.com/synarkos/synarkos/blob/master/synarkos_logo_new.png?raw=true"
    ...
    try:
        ...
        test_img = "https://github.com/synarkos/synarkos/blob/master/synarkos_logo_new.png?raw=true"
    ...
    try:
        ...
        processed_messages = llm.openai_vision_processing(
            "Describe this image",
            "https://github.com/synarkos/synarkos/blob/master/synarkos_logo_new.png?raw=true",
            messages.copy(),
        )
    ...
    try:
        ...
        # Test URL detection
        url_test = "https://github.com/synarkos/synarkos/blob/master/synarkos_logo_new.png?raw=true"
    ...
    try:
        ...
        result = llm.vision_processing(
            ...
            image="https://github.com/synarkos/synarkos/blob/master/synarkos_logo_new.png?raw=true",
            messages=messages,
        )
