# SynarkOS Marketplace Apps Documentation


The SynarkOS Apps page (`https://synarkos.world/apps`) is your central hub for managing and customizing your workspace experience. Here you can control which applications appear in your sidebar, organize them using templates, and quickly access the tools you need for different workflows.
...
1. **Visit the Apps Page**: Navigate to `https://synarkos.world/apps`
...
The Apps page puts you in complete control of your SynarkOS experience, ensuring you have the right tools at your fingertips for any task or workflow.