...
class ReasoningAgentRouter:
    """
    A router for advanced reasoning agent synarkos.

    The ReasoningAgentRouter enables dynamic selection, instantiation, and caching of various
    reasoning agent types ("synarkos") for flexible, robust, and scalable problem-solving.
    ...
    def select_swarm(self):
        ...
        try:
            ...
            raise ReasoningAgentInitializationError(
                f"ReasoningAgentRouter Error: {e} Traceback: {traceback.format_exc()} If the error persists, please check the agent's configuration and try again. If you would like support book a call with our team at https://cal.com/synarkos"
            )
