...
from synarkos.utils.disable_logging import disable_logging
from loguru import logger


def bootup():
    """Super-fast initialization of synarkos environment"""
    try:
        # Cache env vars
        verbose = os.getenv("SYNARKOS_VERBOSE_GLOBAL", "False").lower()
