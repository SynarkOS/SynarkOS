...
from synarkos.telemetry.main import log_agent_data
import functools
import inspect
import time
...
def log_function_execution(
    ...
    Args:
        agent_group_id (str, optional): Unique identifier for the swarm instance
        agent_architecture (str, optional): Name of the swarm architecture
    ...
    Example:
        >>> @log_function_execution(agent_group_id="my-swarm", agent_architecture="sequential")
...
def log_execution(
    ...
    Args:
        agent_group_id (str): Unique identifier for the swarm router instance
        ...
        agent_architecture (str): Name of the swarm architecture used
    Returns:
        None

    Example:
        >>> log_execution(
        ...     agent_group_id="swarm-router-abc123",
        ...     status="start",
    ...
    try:
        if enabled_on is None:
            log_agent_data(
                data_dict={
                    "swarm_router_id": agent_group_id,
                    "status": status,
