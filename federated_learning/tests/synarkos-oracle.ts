...
import { SynarkosOracle } from "../target/types/synarkos_oracle";

describe.only("synarkos-oracle", () => {
  ...
  const program = anchor.workspace.SynarkosOracle as Program<SynarkosOracle>;
  ...
  const ephemeralProgram = new Program<SynarkosOracle>(
    program.idl,
