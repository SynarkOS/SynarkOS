...
from synarkos.telemetry.log_executions import log_function_execution
...
class DataProcessor:
    ...
    @log_function_execution(
        agent_group_id="data-processor-instance",
        agent_architecture="object_oriented",
        enabled_on=True,
    )
    ...
    @classmethod
    @log_function_execution(
        agent_group_id="data-processor-class",
        agent_architecture="class_method",
        enabled_on=True,
    )
    ...
    @staticmethod
    @log_function_execution(
        agent_group_id="data-processor-static",
        agent_architecture="utility",
        enabled_on=True,
    )
...
class AdvancedProcessor(DataProcessor):
    ...
    @log_function_execution(
        agent_group_id="advanced-processor",
        agent_architecture="inheritance",
        enabled_on=True,
    )
