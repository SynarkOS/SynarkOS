...
This directory contains runnable examples that demonstrate AOP (Agents over Protocol) patterns in SynarkOS: spinning up a simple MCP server, discovering available agents/tools, and invoking agent tools from client scripts.
