from synarkos_tools import crawl_entire_site_firecrawl
...
out = agent.run(
    "Crawl 2-3 pages of synarkos.ai and improve the marketing copy found on those pages. Return the improved copy in a structured format."
)
print(out)
