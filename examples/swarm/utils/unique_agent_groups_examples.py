...
def run_mathematical_finance_synarkos():
    """Complex financial analysis using mathematical synarkos"""
    print_separator()
...
def run_healthcare_pattern_synarkos():
    """Patient monitoring using pattern synarkos"""
    print_separator()
...
async def run_all_examples():
    ...
    run_mathematical_finance_synarkos()

    # Healthcare examples
    run_healthcare_grid_swarm()
    run_healthcare_star_swarm()
    run_healthcare_pattern_synarkos()
