...
from synarkos_tools import scrape_and_format_sync
...
swarm.run(
    task="Scrape synarkos.ai website and provide a full report of the company does. The format type should be full.",
