...
This example shows how to deploy your SynarkOS agents as a REST API using FastAPI and Uvicorn.
...
app = FastAPI(
    title="SynarkOS Agent API",
    description="REST API for SynarkOS agents - Quantitative Trading Example",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
)
...
async def root():
    ...
    return {
        "message": "SynarkOS Agent API is running!",
        "status": "healthy",
        "version": "1.0.0",
        "docs": "/docs",
    }
...
if __name__ == "__main__":
    print("Starting SynarkOS Agent API...")
    print(
